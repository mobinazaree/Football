     ...
     // button for germany
        ...
        franceBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // get league Data
                leagueData = FootballAppAPI.getLeagueData("france");
        ...
        // button for england
        JButton englandBtn = new JButton("England");
        englandBtn.setBounds(400, 80, 150, 40);
        englandBtn.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));			
        englandBtn.setFont(new Font("Arial", Font.BOLD, 14));
        
        englandBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ...
                // get league Data
                leagueData = FootballAppAPI.getLeagueData("england");
        ...
        // button for world cup
        JButton worldBtn = new JButton("World Cup");
        worldBtn.setBounds(220, 130, 150, 40);
        worldBtn.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));			
        worldBtn.setFont(new Font("Arial", Font.BOLD, 14));
        ...
        worldBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // get league Data
                leagueData = FootballAppAPI.getLeagueData("world cup");
